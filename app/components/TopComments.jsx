...
export default function TopComments() {
  ...
  return (
    <>
      {comments.length > 0 ? (
        <section className="montserrat-font w-full py-10 bg-gray-100 rounded-xl text-black mb-1 px-4 md:px-12">
          <div className="montserrat-font max-w-7xl mx-auto flex flex-col gap-8">
            ...
            <div className="montserrat-font flex gap-8 overflow-x-auto py-4 scrollbar-hide px-4">
              {comments.map((item, idx) => (
                <div
                  key={idx}
                  className="montserrat-font flex flex-col items-start justify-evenly min-w-[300px] min-h-[150px] bg-white rounded-2xl p-6 transition hover:scale-110"
                >
